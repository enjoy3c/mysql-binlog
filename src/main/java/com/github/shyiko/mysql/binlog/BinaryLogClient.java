...
public class BinaryLogClient implements BinaryLogClientMXBean {
    ...
    public BinaryLogClient(String username, String password) {
        this("localhost", 3306, null, username, password,4l);
    }
    ...
    public BinaryLogClient(String schema, String username, String password) {
        this("localhost", 3306, schema, username, password,4l);
    }
     ...
     * @see BinaryLogClient#BinaryLogClient(String, int, String, String, String)
     */
    public BinaryLogClient(String hostname, int port, String username, String password,long binlogPosition) {
        this(hostname, port, null, username, password,binlogPosition);
    }
     ...
     */
    public BinaryLogClient(String hostname, int port, String schema, String username, String password,long binlogPosition) {
